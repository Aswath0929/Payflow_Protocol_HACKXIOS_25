...
## 🤖 Expert AI Oracle Architecture

### AI Fraud Detection Layer

The Expert AI Oracle v3.0 provides real-time fraud detection integrated with the settlement layer:

```
┌────────────────────────────────────────────────────────────────────────────┐
│                    EXPERT AI ORACLE v3.0 ARCHITECTURE                       │
├────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│   ┌─────────────────────────────────────────────────────────────────────┐  │
...
│   │                              ▼                                       │  │
│   │              ┌───────────────────────────────────┐                   │  │
│   │              │  WEIGHTED ENSEMBLE + ECDSA SIGN   │                   │  │
│   │              │  Score = Σ(model_i × weight_i)    │                   │  │
│   │              └───────────────────────────────────┘                   │  │
│   └─────────────────────────────────────────────────────────────────────┘  │
│                                   │                                        │
│                                   ▼                                        │
...
│   │  • Risk score threshold enforcement (>80 = BLOCK)                   │  │
│   │  • Audit trail logging                                               │  │
│   └─────────────────────────────────────────────────────────────────────┘  │
│                                                                             │
└────────────────────────────────────────────────────────────────────────────┘
...
The Expert AI Oracle exposes REST endpoints at `http://localhost:8000`:

| Endpoint | Method | Purpose |
|----------|--------|---------|
| `/expert/analyze` | POST | Full 4-model fraud analysis |
| `/analyze` | POST | Standard analysis (compatibility) |
...
- [x] Deploy SettlementProtocol with oracle addresses
- [x] Verify contract on Etherscan (Sepolia)
- [x] Test all functions on testnet
- [x] Configure frontend with deployed address
- [x] Update deployedContracts.ts
- [x] Deploy Expert AI Oracle API
- [x] Integrate AI Fraud Dashboard

---

*Document Version: 2.0*  
*Last Updated: June 2025*  
*Authors: TheBlocks Team - Hackxios 2K25*
