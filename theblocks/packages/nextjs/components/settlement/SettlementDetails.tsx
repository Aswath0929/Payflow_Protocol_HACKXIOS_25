...
export const SettlementDetails = ({ settlementId, onClose }: SettlementDetailsProps) => {
  ...
  const handleDeposit = async () => {
    ...
    try {
      await deposit();
      notification.success("Deposit successful! (Demo)");
      setDepositAmount("");
    } catch (error: unknown) {
      notification.error(error instanceof Error ? error.message : "Deposit failed");
    }
  };
  ...
  const handleInitiate = async () => {
    try {
      ...
      notification.success("Settlement initiated! (Demo)");
    } catch (error: unknown) {
      notification.error(error instanceof Error ? error.message : "Initiation failed");
    }
  };
  ...
  const handleExecute = async () => {
    try {
      ...
      notification.success("Transfers executed! (Demo)");
    } catch (error: unknown) {
      notification.error(error instanceof Error ? error.message : "Execution failed");
    }
  };
  ...
  const handleRefund = async () => {
    try {
      ...
      notification.success("Refund processed! (Demo)");
    } catch (error: unknown) {
      notification.error(error instanceof Error ? error.message : "Refund failed");
    }
  };
  ...
  const handleDispute = async () => {
    ...
    try {
      ...
      notification.success("Dispute submitted! (Demo)");
      setDisputeReason("");
      setShowDisputeForm(false);
    } catch (error: unknown) {
      notification.error(error instanceof Error ? error.message : "Dispute failed");
    }
  };
